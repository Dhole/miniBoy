...
SET_OP(0x02, "LD (BC),A", op_ld_8, regs.BC, regs.A, MEM_W_16, 1, 8, 0);
...
SET_OP(0x08, "LD (a16),SP", op_ld_16, imm_16, regs.SP, MEM_W_16, 3, 20, 0);
SET_OP(0x09, "ADD HL,BC", op_add_16, regs.HL, regs.BC, NONE, 1, 8, 0);
SET_OP(0x0A, "LD A,(BC)", op_ld_8, regs.A, regs.BC, MEM_R_16, 1, 8, 0);
...
SET_OP(0x12, "LD (DE),A", op_ld_8, regs.DE, regs.A, MEM_W_16, 1, 8, 0);
...
SET_OP(0x1A, "LD A,(DE)", op_ld_8, regs.A, regs.DE, MEM_R_16, 1, 8, 0);
...
SET_OP(0x46, "LD B,(HL)", op_ld_8, regs.B, regs.HL, MEM_R_16, 1, 8, 0);
...
SET_OP(0x4E, "LD C,(HL)", op_ld_8, regs.C, regs.HL, MEM_R_16, 1, 8, 0);
...
SET_OP(0x56, "LD D,(HL)", op_ld_8, regs.D, regs.HL, MEM_R_16, 1, 8, 0);
...
SET_OP(0x5E, "LD E,(HL)", op_ld_8, regs.E, regs.HL, MEM_R_16, 1, 8, 0);
...
SET_OP(0x66, "LD H,(HL)", op_ld_8, regs.H, regs.HL, MEM_R_16, 1, 8, 0);
...
SET_OP(0x6E, "LD L,(HL)", op_ld_8, regs.L, regs.HL, MEM_R_16, 1, 8, 0);
SET_OP(0x6F, "LD L,A", op_ld_8, regs.L, regs.A, NONE, 1, 4, 0);
SET_OP(0x70, "LD (HL),B", op_ld_8, regs.HL, regs.B, MEM_W_16, 1, 8, 0);
SET_OP(0x71, "LD (HL),C", op_ld_8, regs.HL, regs.C, MEM_W_16, 1, 8, 0);
SET_OP(0x72, "LD (HL),D", op_ld_8, regs.HL, regs.D, MEM_W_16, 1, 8, 0);
SET_OP(0x73, "LD (HL),E", op_ld_8, regs.HL, regs.E, MEM_W_16, 1, 8, 0);
SET_OP(0x74, "LD (HL),H", op_ld_8, regs.HL, regs.H, MEM_W_16, 1, 8, 0);
SET_OP(0x75, "LD (HL),L", op_ld_8, regs.HL, regs.L, MEM_W_16, 1, 8, 0);
SET_OP(0x76, "HALT", op_halt, NULL, NULL, NONE, 1, 4, 0);
SET_OP(0x77, "LD (HL),A", op_ld_8, regs.HL, regs.A, MEM_W_16, 1, 8, 0);
...
SET_OP(0x7E, "LD A,(HL)", op_ld_8, regs.A, regs.HL, MEM_R_16, 1, 8, 0);
...
SET_OP(0x86, "ADD A,(HL)", op_add_8, regs.A, regs.HL, MEM_R_16, 1, 8, 0);
...
SET_OP(0x8E, "ADC A,(HL)", op_adc, regs.A, regs.HL, MEM_R_16, 1, 8, 0);
...
SET_OP(0x96, "SUB (HL)", op_sub, regs.A, regs.HL, MEM_R_16, 1, 8, 0);
...
SET_OP(0x9E, "SBC A,(HL)", op_sbc, regs.A, regs.HL, MEM_R_16, 1, 8, 0);
...
SET_OP(0xA6, "AND (HL)", op_and, regs.A, regs.HL, MEM_R_16, 1, 8, 0);
...
SET_OP(0xAE, "XOR (HL)", op_xor, regs.A, regs.HL, MEM_R_16, 1, 8, 0);
...
SET_OP(0xB6, "OR (HL)", op_or, regs.A, regs.HL, MEM_R_16, 1, 8, 0);
...
SET_OP(0xBE, "CP (HL)", op_cp, regs.A, regs.HL, MEM_R_16, 1, 8, 0);
...
SET_OP(0xE0, "LDH (a8),A", op_ld_8, imm_8, regs.A, MEM_W_8, 2, 12, 0);
SET_OP(0xE1, "POP HL", op_pop, regs.HL, NULL, NONE, 1, 12, 0);
SET_OP(0xE2, "LD (C),A", op_ld_8, regs.C, regs.A, MEM_W_8, 1, 8, 0);
...
SET_OP(0xF0, "LDH A,(a8)", op_ld_8, regs.A, imm_8, MEM_R_8, 2, 12, 0);
SET_OP(0xF1, "POP AF", op_pop, regs.AF, NULL, NONE, 1, 12, 0);
SET_OP(0xF2, "LD A,(C)", op_ld_8, regs.A, regs.C, MEM_R_8, 1, 8, 0);
...
SET_OP(0xFA, "LD A,(a16)", op_ld_8, regs.A, imm_16, MEM_R_16, 3, 16, 0);
...
SET_OP_CB(0x06, "RLC (HL)", op_rlc, regs.HL, NULL, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0x0E, "RRC (HL)", op_rrc, regs.HL, NULL, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0x16, "RL (HL)", op_rl, regs.HL, NULL, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0x1E, "RR (HL)", op_rr, regs.HL, NULL, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0x26, "SLA (HL)", op_sla, regs.HL, NULL, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0x2E, "SRA (HL)", op_sra, regs.HL, NULL, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0x36, "SWAP (HL)", op_swap, regs.HL, NULL, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0x3E, "SRL (HL)", op_srl, regs.HL, NULL, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0x46, "BIT 0,(HL)", op_bit, regs.HL, &C_0, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0x4E, "BIT 1,(HL)", op_bit, regs.HL, &C_1, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0x56, "BIT 2,(HL)", op_bit, regs.HL, &C_2, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0x5E, "BIT 3,(HL)", op_bit, regs.HL, &C_3, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0x66, "BIT 4,(HL)", op_bit, regs.HL, &C_4, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0x6E, "BIT 5,(HL)", op_bit, regs.HL, &C_5, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0x76, "BIT 6,(HL)", op_bit, regs.HL, &C_6, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0x7E, "BIT 7,(HL)", op_bit, regs.HL, &C_7, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0x86, "RES 0,(HL)", op_res, regs.HL, &C_0, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0x8E, "RES 1,(HL)", op_res, regs.HL, &C_1, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0x96, "RES 2,(HL)", op_res, regs.HL, &C_2, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0x9E, "RES 3,(HL)", op_res, regs.HL, &C_3, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0xA6, "RES 4,(HL)", op_res, regs.HL, &C_4, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0xAE, "RES 5,(HL)", op_res, regs.HL, &C_5, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0xB6, "RES 6,(HL)", op_res, regs.HL, &C_6, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0xBE, "RES 7,(HL)", op_res, regs.HL, &C_7, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0xC6, "SET 0,(HL)", op_set, regs.HL, &C_0, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0xCE, "SET 1,(HL)", op_set, regs.HL, &C_1, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0xD6, "SET 2,(HL)", op_set, regs.HL, &C_2, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0xDE, "SET 3,(HL)", op_set, regs.HL, &C_3, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0xE6, "SET 4,(HL)", op_set, regs.HL, &C_4, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0xEE, "SET 5,(HL)", op_set, regs.HL, &C_5, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0xF6, "SET 6,(HL)", op_set, regs.HL, &C_6, MEM_RW_16, 2, 16, 0);
...
SET_OP_CB(0xFE, "SET 7,(HL)", op_set, regs.HL, &C_7, MEM_RW_16, 2, 16, 0);
