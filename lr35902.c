...
SET_OP_CB(0x46, "BIT 0,(HL)", op_bit, regs.HL, &C_0, MEM_RW_16a, 2, 16, 0);
...
SET_OP_CB(0x4E, "BIT 1,(HL)", op_bit, regs.HL, &C_1, MEM_RW_16a, 2, 16, 0);
...
SET_OP_CB(0x56, "BIT 2,(HL)", op_bit, regs.HL, &C_2, MEM_RW_16a, 2, 16, 0);
...
SET_OP_CB(0x5E, "BIT 3,(HL)", op_bit, regs.HL, &C_3, MEM_RW_16a, 2, 16, 0);
...
SET_OP_CB(0x66, "BIT 4,(HL)", op_bit, regs.HL, &C_4, MEM_RW_16a, 2, 16, 0);
...
SET_OP_CB(0x6E, "BIT 5,(HL)", op_bit, regs.HL, &C_5, MEM_RW_16a, 2, 16, 0);
...
SET_OP_CB(0x76, "BIT 6,(HL)", op_bit, regs.HL, &C_6, MEM_RW_16a, 2, 16, 0);
...
SET_OP_CB(0x7E, "BIT 7,(HL)", op_bit, regs.HL, &C_7, MEM_RW_16a, 2, 16, 0);
